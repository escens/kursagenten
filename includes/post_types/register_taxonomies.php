...
add_action( 'init', function() {
    ...
    register_taxonomy( 'coursecategory', array('course', 'coursedate', 'instructor'), array(
        ...
        'public' => true,
        'hierarchical' => true, // Gjør at kategoriene kan være hierarkiske
        'show_in_menu' => true,
        'show_in_rest' => true,
        'show_admin_column' => true,
        'rewrite' => array(
            'slug' => $kurskategori, // Tilpasset slug basert på bedriftsvariabel
        ),
    ));
    ...
    register_taxonomy( 'course_location', array('course', 'coursedate', 'instructor'), array(
        ...
        'public' => true,
        'hierarchical' => true, // Gjør at kurssteder kan være hierarkiske
        'show_in_menu' => true,
        'show_admin_column' => true,
        'show_in_rest' => true,
        'rewrite' => array(
            'slug' => $kurssted, // Tilpasset slug basert på bedriftsvariabel
        ),
    ));
