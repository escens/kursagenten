<?php
/**
 * Standard template for taxonomy archives
 * 
...
$meta = get_taxonomy_meta($term->term_id, $taxonomy);
?>

<div id="primary" class="content-area">
    <main id="main" class="site-main taxonomy-archive <?php echo esc_attr($taxonomy); ?>" role="main">
