...
class GridStyles {
    ...
    public static function get_grid_styles(string $id, array $a): string {
        ...
        return "<style>
            ...
            {$class_id}.rad a.image { max-width: 30vw; height: 100%;}
            ...
            {$class_id}.rad .text .info{ width: 100%; padding-left: 1em; display: flex; align-items: center; text-align: left; }
            ...
            {$class_id}.rad.kort picture { max-width: calc({$a['bildestr']} * 0.85); padding: 0; border-radius: {$a['bildeform']} 0 0 {$a['bildeform']}; }
