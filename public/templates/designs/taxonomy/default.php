            ...
            <div class="<?php echo esc_attr($grid_classes); ?>">
                <div class="left-column">
                    <?php if (!empty($image_url)): ?>
                        ...
                        ?>
                        <?php
                        $taxonomy_image_title = ($taxonomy === 'ka_instructors' && function_exists('get_instructor_display_name'))
                        ...
                        <div class="taxonomy-image">
                            <img src="<?php echo esc_url($image_url); ?>" 
                                 ...
                                 alt="<?php echo esc_attr($taxonomy_image_title); ?>"
                                 title="<?php echo esc_attr($taxonomy_image_title); ?>">
                        </div>
                    <?php endif; ?>
