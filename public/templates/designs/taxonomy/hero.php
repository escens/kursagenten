...
<style>
    ...
    .taxonomy-hero-header .background-blur {
        background-image: url('<?php echo esc_url($hero_image_full); ?>');
    }

    @media (max-width: 1600px) {
        .taxonomy-hero-header .background-blur {
            background-image: url('<?php echo esc_url($hero_image_large); ?>');
        }
    }

    @media (max-width: 1024px) {
        .taxonomy-hero-header .background-blur {
            background-image: url('<?php echo esc_url($hero_image_medium); ?>');
        }
    }

    @media (max-width: 768px) {
        .taxonomy-hero-header .background-blur {
            background-image: url('<?php echo esc_url($hero_image_thumb); ?>');
        }
    }
</style>
...
<article class="ka-outer-container taxonomy-container view-type-<?php echo esc_attr(str_replace('_', '', $view_type)); ?>">
    <header class="ka-section ka-header taxonomy-hero-header<?php echo $has_taxonomy_image ? '' : ' no-hero-image'; ?>">
        <div class="ka-content-container">
            ...
            <div class="ka-content-container header-content taxonomy-header-content">
    ...
    <?php $footer_bildestr = (get_taxonomy_setting($taxonomy, 'show_images', 'yes') === 'yes') ? '100px' : '0px'; ?>
