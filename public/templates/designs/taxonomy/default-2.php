...
// Accessible image labels for instructors follow name display settings (header + content images).
$taxonomy_header_media_title = ($taxonomy === 'ka_instructors' && function_exists('get_instructor_display_name'))
                ...
                <?php if (!empty($ka_image_url)): ?>
                    ...
                    <div class="taxonomy-header-image">
                        <img src="<?php echo esc_url($ka_image_url); ?>" 
                             ...
                             alt="<?php echo esc_attr($taxonomy_header_media_title); ?>"
                             title="<?php echo esc_attr($taxonomy_header_media_title); ?>">
                    </div>
                <?php endif; ?>
